...
import com.spicagenmod.smparts.utils.PowerWidgetUtil;
import com.spicagenmod.smparts.widgets.TouchInterceptor;
...
public class PowerWidgetOrderActivity extends ListActivity
{
    ...
    private class ButtonAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            int resId = button.getIconResId();
            if(resId > 0) {
                try {
                    icon.setVisibility(View.VISIBLE);
                    icon.setImageResource(resId);
                } catch(Exception e) {
                    Log.e(TAG, "Error retrieving icon resource", e);
                }
            }
            return v;
        }
